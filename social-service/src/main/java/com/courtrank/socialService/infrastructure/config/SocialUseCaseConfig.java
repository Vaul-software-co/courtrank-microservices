...
public class SocialUseCaseConfig {
    ...
    @Bean public DeleteSocialUserFromUserEventUseCase deleteSocialUserFromUserEventUseCase(SocialUserRepository socialUserRepository, FollowRepository followRepository, SocialCounterRepository socialCounterRepository) { return new DeleteSocialUserFromUserEventUseCase(socialUserRepository, followRepository, socialCounterRepository); }
