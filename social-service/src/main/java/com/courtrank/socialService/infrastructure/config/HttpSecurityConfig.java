...
import com.courtrank.socialService.infrastructure.security.InternalApiKeyFilter;
import com.courtrank.socialService.infrastructure.security.JwtAuthenticationFilter;
...
public class HttpSecurityConfig {
    ...
    @Bean
    public InternalApiKeyFilter internalApiKeyFilter(@Value("${app.internal-api-key}") String internalApiKey) {
