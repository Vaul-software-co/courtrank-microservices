...
import com.courtrank.authService.infrastructure.security.ApiKeyFilter;
import com.courtrank.authService.infrastructure.security.InMemoryRateLimitFilter;
import com.courtrank.authService.infrastructure.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/user/me/data-consent").authenticated()
